...
function directTrueFalsePromptSv(
  source: PracticeQuestion,
  variant: 'section' | 'judgement',
): string {
...
function directTrueFalsePromptEn(
  source: PracticeQuestion,
  variant: 'section' | 'judgement',
): string {
...
function rephrasedSingleChoicePromptSv(
  source: PracticeQuestion,
  variant: 'section' | 'judgement',
): string {
...
function rephrasedSingleChoicePromptEn(
  source: PracticeQuestion,
  variant: 'section' | 'judgement',
): string {
