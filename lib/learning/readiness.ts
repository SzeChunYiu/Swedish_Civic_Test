...
type QuestionProgressSnapshot = Pick<
  QuestionProgress,
  'seenCount' | 'correctCount' | 'lastAnsweredAt'
>;

type ReadinessQuestionLike = Pick<PracticeQuestion, 'id' | 'chapterId'>;

type MockExamReadinessSnapshot = Pick<MockExamProgress, 'score' | 'completedAt'>;
