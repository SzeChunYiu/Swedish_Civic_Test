...
export const MOCK_EXAM_LIBRARY: readonly MockExamDescriptor[] = [
  {
    id: 'mock-1',
    labelSv: 'Provexamen 1 – Mjuk start',
  ...
  {
    id: 'mock-4',
    labelSv: 'Provexamen 4 – Standard plus',
  ...
  {
    id: 'mock-6',
    labelSv: 'Provexamen 6 – Slutspurt',
  ...
  {
    id: 'mock-random',
    labelSv: 'Slumpmässig provexamen',
