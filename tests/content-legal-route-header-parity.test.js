...
const expectedLegalRoutes = [
  ...
  },
  {
    ...
    requiredSnippets: [
      ...
      'Google UMP-samtyckesformuläret',
      'icke-personanpassade annonser',
      'Privacy policy',
      'Account optional',
...
test('privacy Remove Ads rendered copy e2e covers both languages', () => {
  ...
  for (const snippet of [
    ...
    'På iOS begärs App Tracking Transparency innan spårningsbaserad annonsering',
    'Google UMP-samtyckesformuläret',
    'icke-personanpassade annonser',
    'Remove Ads is a one-time, non-consumable purchase for 29 SEK',
    'turns off ads on this device',
    'can be restored through the app store',
    'On iOS, App Tracking Transparency is requested before tracking-based advertising',
    'Google UMP consent form',
    'non-personalized ads',
    'Google Mobile Ads',
    'Timed mock exam screens stay ad-free',
    'Tidsatta provskärmar är annonsfria',
    '/privacy refreshes Remove Ads and ad consent legal copy after language selection changes',
