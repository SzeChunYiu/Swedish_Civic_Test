...
const architectureExpectedExports = {
  ...
  'lib/scaffold/architectureManifest.ts': [
    'ArchitectureAppConfigRuntimeFilePath',
    'ArchitectureAnswerShuffleReviewRuntimeFilePath',
    'ArchitectureAnswerShuffleRuntimeFilePath',
    'ArchitectureComplianceSupportFilePath',
    'ArchitectureContentDerivationRuntimeFilePath',
    'ArchitectureDesignSystemSupportFilePath',
    'ArchitectureLearningProgressRuntimeFilePath',
    'ArchitectureLegalRouteRuntimeFilePath',
    'ArchitectureMistakeReviewRuntimeFilePath',
    'ArchitectureMockExamRuntimeFilePath',
    'ArchitectureMonetizationRuntimeFilePath',
    'ArchitecturePracticeFlowRuntimeFilePath',
    'ArchitectureProductCoverageRoot',
    'ArchitectureQuestionLanguageRuntimeFilePath',
    'ArchitectureSourceCitationBoundaryRuntimeFilePath',
    'ArchitectureQuestionSurfaceRuntimeFilePath',
    'ArchitectureQuizFeedbackRuntimeFilePath',
    'ArchitectureRemoveAdsRuntimeFilePath',
    'ArchitectureRouteCopyRuntimeFilePath',
    ...
    'ArchitectureScaffoldToolingFilePath',
    'ArchitectureSettingsPreferenceRuntimeFilePath',
    'ArchitectureSettingsRuntimeFilePath',
    'ArchitectureSharedUiRuntimeFilePath',
    'ArchitectureSourceCitationRuntimeFilePath',
    'ArchitectureSpeechRuntimeFilePath',
    'ArchitectureSupplementalRouteFilePath',
    'ArchitectureTabNavigationRuntimeFilePath',
    ...
    'architectureSpeechRuntimeFiles',
  ...
  'lib/scaffold/routerShellManifest.ts': [
    'ExpoRouterNativeIntentConfigFile',
    'ExpoRouterDynamicRoute',
    'ExpoRouterDynamicRouteHrefSample',
    'ExpoRouterDynamicRouteName',
    'ExpoRouterNativeIntentDynamicRoute',
    'ExpoRouterNativeIntentDynamicRoutePath',
    'ExpoRouterNativeIntentRuntimeSample',
    'ExpoRouterNativeIntentRuntimeSampleInput',
    'ExpoRouterNativeIntentStaticRoute',
    'ExpoRouterRootLayoutGlobalPlacement',
    'ExpoRouterRootLayoutGlobalPlacementName',
    'ExpoRouterRootStackScreen',
    'ExpoRouterRootStackScreenName',
    'ExpoRouterShellFile',
    'ExpoRouterShellFilePath',
    'ExpoRouterShellRecoveryHref',
    'ExpoRouterShellRole',
    'ExpoRouterStandaloneRoute',
    'ExpoRouterStandaloneRouteHref',
    'ExpoRouterStandaloneHeaderHiddenRoute',
    'ExpoRouterStandaloneRouteName',
    'ExpoRouterTabScreen',
    'ExpoRouterTabScreenName',
    'ExpoRouterWebDocumentMetaDescription',
    'ExpoRouterWebDocumentMetaDescriptionLanguage',
    'expoRouterNativeIntentConfigFiles',
