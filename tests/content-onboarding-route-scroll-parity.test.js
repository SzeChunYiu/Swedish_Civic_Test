...
test('onboarding route keeps mobile content inside a scrollable root', () => {
...
test('onboarding route scroll parity rejects an unscrollable root container', () => {
...
`,
  ...
  assert.match(
    `${result.stdout}\n${result.stderr}`,
    /onboarding route must keep its root content inside ScrollView for mobile scrolling/,
  );
});
