...
const examRouteCopy: Record<AppLanguage, ExamRouteCopy> = {
  sv: {
    ...
    extraExamUnavailable: 'Det går inte att starta ett extra övningsprov just nu.',
    ...
    resultBadge: 'Övningsprovsresultat',
    resultNote:
    ...
    submitLabel: 'Skicka in övningsprov',
  ...
  en: {
    ...
    examResultTitle: 'Result from mock exam',
    extraExamUnavailable: 'An extra mock exam cannot be started right now.',
    heroSubtitle: (durationMinutes, questionCount) =>
    ...
    rewardedAdStatus: {
      ...
      earned_reward: 'Extra mock exam reward earned.',
    ...
    submitLabel: 'Submit mock exam answers',
