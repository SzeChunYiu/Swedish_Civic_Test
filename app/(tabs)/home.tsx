...
const homeCopy: Record<AppLanguage, HomeCopy> = {
  sv: {
    ...
    feedbackBadge: 'Förbättrat studieflöde',
    ...
    feedbackTitle: 'Uppdaterat för praktiska studiebehov',
    levelMetric: 'nivå',
  ...
  en: {
    ...
    feedbackBadge: 'Study-loop improvements',
    ...
    feedbackTitle: 'Updated around real study needs',
    levelMetric: 'level',
