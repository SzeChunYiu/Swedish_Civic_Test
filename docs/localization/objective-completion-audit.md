...
- This branch adds preview-only Simplified Chinese mock-exam setup/results and mistake-review labels while keeping `zh-Hans` blocked.
...
After the preview-only `zh-Hans` mock-exam/mistake-review slice, continue with the next bounded app UI surface before any release enablement:

1. Add preview-only Simplified Chinese copy for dashboard/learning/chapter-card surfaces and their accessibility labels.
