...
(function () {
  ...
  const extra = {
    ...
    "zh-Hans": {
      ...
      "footer.h.legal": "细则",
      "footer.h.about": "关于",
      "footer.about.p": "一个独立的学习工具,由亲自参加过考试的人构建。核心 500 题永久免费。",
      "footer.h.fika": "心情",
    ...
    "zh-Hant": {
      ...
      "footer.h.legal": "細則",
      "footer.h.about": "關於",
      "footer.about.p": "一個獨立的學習工具,由親自參加過考試的人建構。核心 500 題永久免費。",
      "footer.h.fika": "心情",
    ...
    "ar": {
      ...
      "footer.h.about": "نبذة",
      "footer.about.p": "أداة دراسة مستقلة، بناها أشخاص اجتازوا الاختبار بأنفسهم. مجاني للأسئلة الـ500 الأساسية، إلى الأبد.",
    ...
    "so": {
      ...
      "footer.about.p": "Qalab barasho oo madax bannaan, oo ay sameeyeen dad qaaday imtixaanka iyaga laftooda. Bilaash 500-ka su'aal ee aasaasiga ah, weligood.",
      "footer.h.fika": "Niyad",
