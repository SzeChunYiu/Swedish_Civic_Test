...
export const additionalQuestions: PracticeQuestion[] = [
  ...
  trueFalse(
    ...
    'ch09',
    { chapter: 'Välfärdssamhället', section: 'Skatter för Sveriges välfärd', pageApprox: 30 },
    'Sant eller falskt: Enligt UHR-materialet betalas skatt också av företag, och moms är skatt på varor och tjänster.',
    'True or false: According to the UHR material, tax is also paid by companies, and VAT is a tax on goods and services.',
    true,
  ...
  trueFalse(
    ...
    'ch09',
    { chapter: 'Välfärdssamhället', section: 'Kommunerna har ett stort ansvar', pageApprox: 31 },
    'Sant eller falskt: Enligt svensk lag ska kommuner erbjuda äldre stöd och hjälp.',
    'True or false: Under Swedish law, municipalities must offer elderly people support and help.',
    true,
    'UHR-avsnittet Kommunerna har ett stort ansvar säger att kommunens ansvar är att gamla och sjuka kan få hjälp när de inte klarar vardagen själva. Under äldreomsorg står det också att svensk lag kräver att kommuner erbjuder äldre stöd och hjälp.',
    'The UHR section Municipalities have a large responsibility says municipalities are responsible for help for older and sick people who cannot manage everyday life on their own. Under elderly care, it also says Swedish law requires municipalities to offer elderly people support and help.',
