...
export const additionalQuestions: PracticeQuestion[] = [
  ...
  trueFalse(
    ...
    'Sant eller falskt enligt UHR-materialet: Det svenska totalförsvaret omfattar både det militära försvaret och det civila försvaret.',
    'True or false according to the UHR material: Swedish total defence includes both military defence and civil defence.',
    true,
  ...
  single(
    ...
    'Vilket svar stämmer enligt UHR-materialet om Sveriges nationaldag?',
    'Which answer matches the UHR material about Sweden’s National Day?',
    [
      [
        'Den är den 6 juni, då flaggan hissas, tal hålls och många kommuner välkomnar nya medborgare',
        'It is on 6 June, when flags are raised, speeches are held, and many municipalities welcome new citizens',
      ],
      [
        'Den är den 1 maj, då arbetarrörelsen arrangerar demonstrationer',
        'It is on 1 May, when the labour movement arranges demonstrations',
      ],
      [
        'Den är den 31 december, då det nya året firas på natten',
        'It is on 31 December, when the new year is celebrated at night',
      ],
      [
        'Den är den 13 december, då luciafirandet sprider ljus när året är som mörkast',
        'It is on 13 December, when the Lucia celebration spreads light at the darkest time of year',
      ],
    ],
    0,
    'UHR-avsnittet Sveriges nationaldag säger att den 6 juni är Sveriges nationaldag. Avsnittet beskriver också att flaggan hissas, tal hålls och att många kommuner ordnar ceremonier för att välkomna nya medborgare på nationaldagen.',
    'The UHR section Sweden’s National Day says that 6 June is Sweden’s National Day. It also describes flags being raised, speeches being held, and many municipalities arranging ceremonies to welcome new citizens on the National Day.',
