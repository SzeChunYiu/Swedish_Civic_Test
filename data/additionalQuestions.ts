...
export const additionalQuestions: PracticeQuestion[] = [
  ...
  single(
    ...
    "The UHR Children's rights section says that all violence against children is prohibited under both the Convention on the Rights of the Child and Swedish law. It also states that in 1979 Sweden was the first country in the world to decide that hitting children is prohibited, and that the prohibition applies everywhere.",
