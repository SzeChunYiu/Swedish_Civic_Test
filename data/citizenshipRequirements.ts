...
export const citizenshipRequirementAreas = [
  ...
  },
  {
    ...
    detail: {
      sv: 'UHR ansvarar för provet och utbildningsmaterialet. Du kan bara anmäla dig när Migrationsverket har skickat brev, och anmälan öppnar i början av juni 2026 enligt UHR.',
      en: 'UHR is responsible for the test and study material. You can only register after Migrationsverket has sent you a letter, and UHR says registration opens in early June 2026.',
    },
    checklistPrompt: {
