...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    descriptionText: {
      ...
      'zh-Hans': '自由媒体、各类媒体、公共广播服务与信息来源辨析。',
      'zh-Hant': '自由媒體、各類媒體、公共廣播服務與資料來源判讀。',
      ar: 'الإعلام الحرّ، وأنواع وسائل الإعلام المختلفة، وإعلام الخدمة العامة، وتقييم المصادر.',
      ckb: 'ڕاگەیاندنی ئازاد، جۆرە جیاوازەکانی ڕاگەیاندن، ڕاگەیاندنی خزمەتگوزاریی گشتی و هەڵسەنگاندنی سەرچاوە.',
      fa: 'رسانه‌های آزاد، انواع گوناگون رسانه‌ها، رسانهٔ خدمات عمومی و ارزیابی منابع.',
      pl: 'Wolne media, różne rodzaje mediów, media publiczne i ocena wiarygodności źródeł (källkritik).',
      so: 'Warbaahin xor ah, noocyo kala duwan oo warbaahin ah, warbaahinta adeegga dadweynaha iyo qiimeynta ilaha macluumaadka (källkritik).',
      ti: 'ናጻ ማዕከናት ዜና፣ ዝተፈላለዩ ዓይነታት ማዕከናት ዜና፣ ህዝባዊ መሰናድኦ ዜና ከምኡ’ውን ነቐፌታዊ ኣረኣእያ ምንጪ (källkritik)።',
      tr: 'Özgür medya, farklı medya türleri, kamu yayıncılığı ve kaynak değerlendirmesi (källkritik).',
      uk: 'Вільні медіа, різні види медіа, суспільне мовлення та критична оцінка джерел (källkritik).',
    },
    questionCount: 55,
  },
  {
