...
- [ ] Grant EAS build access (factory wires real AdMob IDs into
      `EXPO_PUBLIC_ADMOB_*`)
...
- [ ] App Store Connect: add Pro Lifetime non-consumable product
      `com.billyyiu.almostswedish.prolifetime`, 59 SEK, only after v1.0 is live
