...
| `ads-iap-device-qa`      | Android and iOS EAS preview QA for AdMob test ads, Remove Ads purchase/restore/persistence, ATT/UMP consent, and no ads on exam screens          | `reports/release-ads-iap-device-qa.md` or dated release evidence                                  | BLOCKED        |
...
| `privacy-review`         | Final Apple privacy labels and Google Play Data safety review against generated binary, including Google Mobile Ads, Remove Ads IAP, and ATT/UMP | `reports/privacy-review/privacy-review.json` or dated release evidence                            | BLOCKED        |
