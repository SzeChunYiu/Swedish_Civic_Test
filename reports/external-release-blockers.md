...
| `remove-ads-device-qa`   | Android and iOS EAS preview/TestFlight device QA showing AdMob test ads render, Remove Ads purchase disables ads, entitlement persists after relaunch, restore works, ATT/UMP prompts were exercised, and exam screens render no ads            | `reports/release-ads-iap-device-qa.md` plus `reports/release-device-qa/ios.json` and `android.json` | BLOCKED        |
...
| `privacy-review`         | Final Apple privacy labels and Google Play Data safety review against generated binary, including current Google Mobile Ads real-ad posture, concrete AdMob app/unit IDs, app-ads.txt review, ATT/UMP consent, and 29 SEK Remove Ads IAP review | `reports/privacy-review/privacy-review.json` or dated release evidence                              | BLOCKED        |
