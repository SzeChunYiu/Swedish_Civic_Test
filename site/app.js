...
const i18n = window.i18n = {
  en: {
    ...
    "faq.4.q": "Is it free?",
    "faq.4.a": "Free to start, free to study, and free to take mock exams. Ads help keep the core app available; Remove Ads is an optional one-time 29 SEK purchase that removes ads.",
    ...
    "faq.6.a": "Your study progress, answers, mistakes, and settings stay local. Google AdSense on the website and Google Mobile Ads (AdMob) in the app can process ad and consent signals, but ads never receive your study answers or progress.",
    ...
    "privacy.s4.callout.p": "study progress and answers stay local; ad systems do not receive them.",
    "privacy.s4.p": "We do not run account profiles or send study answers, mistakes, progress, settings, XP, streaks, badges, bookmarks, or audio preferences to ad providers. Google ad systems may process ad and consent signals as described below.",
    "privacy.s5.t": "Ads and purchases",
    "privacy.s5.p": "This website uses Google AdSense. The mobile app uses Google Mobile Ads (AdMob) behind Google's consent flow. Remove Ads is an optional one-time 29 SEK purchase that removes ads. Ads help fund the free study experience, and ads never collect study answers or progress.",
    ...
    "terms.s3.p": "The current question bank is written from UHR's public study material <em>Sverige i fokus</em>, and every question shows its section and page citation. Humans miss things. If you find an error, the <a href=\"#/support\">support page</a> is the fastest fix.",
    ...
    "sources.lede": "The current question bank cites UHR's public study material <em>Sverige i fokus</em>. We don't list other source families until questions backed by them actually ship.",
    ...
    "sources.s1.li1": "<b>UHR — Sverige i fokus</b> — public study material for the Swedish citizenship test.",
    "sources.s1.li2": "Every shipped question cites a chapter, section, and page from this material.",
    "sources.s1.li3": "The public source list changes only when the shipped question bank contains questions with that visible provenance.",
    "sources.s2.t": "How citations work",
    "sources.s2.li1": "Question cards show the source line below the question, separate from the stem.",
    "sources.s2.li2": "The static question bank stores the same source title, chapter, section, and page for every row.",
    "sources.s3.t": "Future source families",
    "sources.s3.li1": "Other public sources may be added later, but only after matching questions ship with visible citations.",
    "sources.s3.li2": "This page is checked against <code>site/questions.js</code> so source copy cannot outrun the current bank.",
  ...
  sv: {
    ...
    "hero.eyebrow": "Inofficiell · Gratis version · Källstödda frågor",
    ...
    "phone.hint": "Snyggt. 18 dagar i rad. Fortsätt.",
    ...
    "faq.3.a": "Nej. Appen kräver ingen registrering. Ingen e-post, inget telefonnummer, ingen pinsam profilbild från 2017. Dina framsteg sparas på enheten.",
    ...
    "privacy.s2.p": "Appen kräver inget konto, ingen e-post, inget telefonnummer och ingen profilregistrering. Du öppnar appen, pluggar, stänger appen. Det är avtalet.",
    ...
    "support.lede": "Vi kan hjälpa med appfel, faktafel, trasigt ljud och otydlig svenska. Vi kan inte ge svar på det riktiga provet, ge migrationsråd eller skynda på Migrationsverket. Tyvärr.",
    ...
    "support.s1.li5": "Ett fel i studieflödet — framsteg som inte sparas, en studiesvit som bryts utan anledning, ett provexempel som inte går att avsluta.",
    "support.s1.li6": "Ett problem med butiken eller installationen — appen kraschar vid start, betalningen krånglar eller en nedladdning vägrar.",
    ...
    "terms.s3.p": "Den nuvarande frågebanken bygger på UHR:s offentliga studiematerial <em>Sverige i fokus</em>, och varje fråga visar avsnitt och sidangivelse. Människor missar saker. Hittar du fel är <a href=\"#/support\">supportsidan</a> snabbaste vägen.",
    ...
    "sources.lede": "Den nuvarande frågebanken hänvisar till UHR:s offentliga studiematerial <em>Sverige i fokus</em>. Vi listar inte andra källfamiljer förrän frågor med den källan faktiskt finns i banken.",
    ...
    "sources.s1.li1": "<b>UHR — Sverige i fokus</b> — offentligt studiematerial för medborgarskapsprovet.",
    "sources.s1.li2": "Varje publicerad fråga anger kapitel, avsnitt och sida från materialet.",
    "sources.s1.li3": "Den offentliga källistan ändras bara när frågebanken innehåller frågor med den synliga proveniensen.",
    "sources.s2.t": "Så fungerar hänvisningar",
    "sources.s2.li1": "Frågekort visar källraden under frågan, separat från frågetexten.",
    "sources.s2.li2": "Den statiska frågebanken lagrar samma källtitel, kapitel, avsnitt och sida för varje rad.",
    "sources.s3.t": "Framtida källfamiljer",
    "sources.s3.li1": "Andra offentliga källor kan läggas till senare, men bara när matchande frågor publiceras med synliga hänvisningar.",
    "sources.s3.li2": "Den här sidan kontrolleras mot <code>site/questions.js</code> så källcopy inte kan springa före den aktuella banken.",
    ...
    "privacy.s5.web.p": "Den här webbplatsen använder <b>Google AdSense</b>. AdSense och dess partner kan sätta cookies på din enhet och använda dem för personalisering, mätning och bedrägeridetektering. Vi laddar AdSense enligt ditt cookieval: <em>Godkänn allt</em> tillåter personaliserade annonser, medan <em>Bara nödvändiga</em> håller annonserna icke-personaliserade. Du kan ändra valet genom att tömma platsdata för domänen.",
