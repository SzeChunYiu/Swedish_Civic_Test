...
const i18n = window.i18n = {
  en: {
    ...
    "faq.6.a": "Your study progress, answers, mistakes, and settings stay local. This website has Google AdSense-ready ad slots that stay disabled until reviewed slot IDs are configured. Google Mobile Ads (AdMob) in the app can process ad and consent signals, but ads never receive your study answers or progress.",
    ...
    "footer.brag1": "Study the material.",
    "footer.brag2": "Practice with sources.",
    ...
    "footer.about.p": "An independent study tool built for source-backed lessons and practice. Free to start, study, and take mock exams.",
  ...
  sv: {
    ...
    "how.s1.p": "Läs en 5-minuters förklaring, gör sedan en kort övning. Som att ha en tålmodig svensk vän som faktiskt avslutar sina meningar.",
    ...
    "how.s3.p": "Öva med ett längre provupplägg och realistisk tidskänsla. Provdagen blir en tisdag med sämre stol.",
    ...
    "footer.brag1": "Plugga materialet.",
    "footer.brag2": "Öva med källor.",
    "footer.h.app": "Appen",
    ...
    "footer.about.p": "Ett fristående studieverktyg för källstödda lektioner och övning. Gratis att börja, plugga och göra provexempel.",
