...
const i18n = window.i18n = {
  en: {
    ...
    "faq.2.a": "It'll help you <em>study</em>. The rest depends on you, UHR's public study material, and your practice habits. We write our own practice questions from <em>Sverige i fokus</em> and show a visible source citation under every question.",
  ...
  sv: {
    ...
    "faq.2.a": "Det hjälper dig att <em>plugga</em>. Resten beror på dig, UHR:s offentliga studiematerial och dina studievanor. Vi skriver egna övningsfrågor från <em>Sverige i fokus</em> och visar en synlig källhänvisning under varje fråga.",
