...
const i18n = window.i18n = {
  en: {
    ...
    "demo.h2": "Just clicks.",
    "demo.deck": "Every question comes with a plain-language explanation and a link to the source. Get it wrong? It quietly shows up again later. Get it right? Move on, pour another coffee.",
    ...
    "qcard.q": "Which Swedish principle gives everyone the right to walk, swim, and pick berries on most land in nature?",
    ...
    "qcard.ex.p": " — \"everyone's right\" — lets you walk, swim, ski, camp, and forage on most land in Sweden. The catch: be careful, considerate, and don't pitch a tent in someone's flowerbed.",
    ...
    "how.s2.p": "Mistakes resurface on the right day. You'll be surprised how quickly Riksdagen stops sounding like furniture.",
    "how.s3.t": "Mock exam — full timing",
    "how.s3.p": "Run the real format under real timing. Test day becomes Tuesday with a worse chair.",
    ...
    "faq.4.q": "Is it free?",
    "faq.4.a": "Free to start, free to take the mock exam, free forever for the core 500 questions. If we ever add premium features, we'll be very obvious about it — Swedish levels of obvious.",
    "faq.5.q": "Does it work in Swedish too?",
    "faq.5.a": "Yes. Toggle the EN / SV switch in the nav, or change it inside the app. Many learners use both at once — read the question in Swedish, peek at the English when you're stuck.",
    "faq.6.q": "Is my data shared with anyone?",
    "faq.6.a": "No. The current build collects nothing and shares nothing. See the <a href=\"#/privacy\">privacy page</a> for the full, deliberately boring version.",
    ...
    "privacy.lede": "Sveriges Medborgartest is an independent study app. We don't ask for an account, we don't run analytics, and we don't sell anything. This page exists so you can verify all of that in writing.",
    ...
    "privacy.s3.p": "Study progress, settings, mistakes, XP, streaks, badges, bookmarks, and audio preferences are stored locally on your device. They never leave it. If you uninstall the app, that data is gone — fair warning.",
    "privacy.s4.t": "Current data-collection posture",
    "privacy.s4.callout.b": "In plain Swedish:",
    "privacy.s4.callout.p": "the current MVP collects no user data and shares no user data.",
    "privacy.s4.p": "No analytics SDKs. No crash reporters that ping home. No third-party trackers. If a future build adds anything that <em>does</em> talk to a server, we'll update this page <em>before</em> the build ships — and the change will be obvious, not buried in legalese.",
    "privacy.s5.t": "Ads and purchases",
    "privacy.s5.p": "The native build includes Google Mobile Ads test configuration, but real ad rendering is disabled for the v1.0 release candidate. If real ad requests, in-app purchases, analytics, crash-reporting, or support SDKs are ever enabled, this privacy policy, the Apple privacy labels, the Google Play Data-safety answers, and the in-app privacy copy will all be reviewed and updated <em>before</em> submission.",
    "privacy.s6.t": "Changes & contact",
    "privacy.s6.p": "If this policy changes, the effective date at the top of this page will change with it. Questions, concerns, or \"wait, what does this actually mean?\" — head over to the <a href=\"#/support\">support page</a>.",

    "support.kicker": "Support",
    "support.h1a": "Something broken?",
    "support.h1b": "Let us fix it.",
    "support.lede": "We can help with app bugs, content errors, broken audio, and confusing Swedish wording. We can't tell you the answers to the real exam, give immigration advice, or speed up Migrationsverket. Sorry.",
    ...
    "support.s1.li1": "A content issue — a wrong answer, an outdated reference, a typo with attitude.",
    ...
    "support.s1.li4": "An audio problem — clip cutting off, wrong pronunciation, silence where speech should be.",
    "support.s1.li5": "A study-flow bug — progress that didn't save, a streak that broke for no reason, an unfinishable mock exam.",
    "support.s1.li6": "A store or build issue — crash on launch, billing weirdness, a download that won't.",
    ...
    "support.s3.callout.p": "Don't send government identifiers (personnummer, samordningsnummer), immigration case details, passport scans, financial info, or anything you wouldn't write on a postcard.",
    ...
    "support.s5.p": "Email <a href=\"mailto:support@medborgartest.app\">support@medborgartest.app</a>. We read everything. We answer almost everything. Privacy details live on the <a href=\"#/privacy\">privacy page</a>.",

    "terms.kicker": "Terms of use",
    "terms.h1a": "Plain rules,",
    "terms.h1b": "plainly written.",
    "terms.lede": "Using the app means you agree to these terms. They are short on purpose. If anything here feels unclear, the support page is one tap away.",
    ...
    "terms.s3.p": "Questions are written from public sources — Riksdagen, Skolverket, statistical reports — and reviewed by humans. Humans miss things. If you find an error, the <a href=\"#/support\">support page</a> is the fastest fix.",
    "terms.s4.t": "No guarantees",
    "terms.s4.p": "We don't guarantee you'll pass the official test. We don't guarantee the app works perfectly on every device on every day. We do guarantee we'll keep trying.",
    "terms.s5.t": "Liability",
    "terms.s5.callout": "<b>Short version:</b> the app is provided \"as is\", to the maximum extent permitted by Swedish law. We are not liable for missed deadlines, denied applications, fika injuries, or any decision an actual government agency makes about your case.",
    "terms.s6.t": "Changes",
    "terms.s6.p": "If these terms change materially, the effective date above will change and the app will surface a notice on next launch. Continued use after that means you accept the new terms.",

    "sources.kicker": "Sources & method",
    "sources.h1a": "Where the answers",
    "sources.h1b": "actually come from.",
    "sources.lede": "Every question in the app is grounded in a public source. We don't have a back-channel to UHR. We just read carefully and cite obsessively.",
    "sources.meta1.b": "Primary sources",
    "sources.meta1.v": "8",
    "sources.meta2.b": "Last review",
    "sources.meta2.v": "2026-05",
    "sources.meta3.b": "Open data",
    "sources.meta3.v": "CC-licensed where possible",
    "sources.toc": "Categories",
    "sources.s1.t": "Government & constitutional",
    "sources.s1.li1": "<b>Riksdagen</b> — the four basic laws (grundlagarna), parliamentary procedure, voting rules.",
    "sources.s1.li2": "<b>Regeringen.se</b> — government structure, ministerial roles.",
    "sources.s1.li3": "<b>Migrationsverket</b> — citizenship requirements, residence permits, the legal path.",
    "sources.s2.t": "Education & civic curriculum",
    "sources.s2.li1": "<b>Skolverket</b> — civic-knowledge framework and curriculum guidance.",
    "sources.s2.li2": "<b>UHR</b> — the agency administering the official test. Public documentation only.",
    "sources.s3.t": "Statistics & facts",
    "sources.s3.li1": "<b>SCB (Statistiska centralbyrån)</b> — demographics, population, labour-market figures.",
    "sources.s3.li2": "<b>Folkhälsomyndigheten</b> — public-health and welfare references.",
    "sources.s4.t": "History, geography & culture",
    "sources.s4.li1": "<b>Nationalencyklopedin</b> — historical timelines and biographies.",
    "sources.s4.li2": "<b>Institutet för språk och folkminnen</b> — traditions, dialects, calendar customs.",
    ...
    "consent.body": "We use Google AdSense to show a couple of ads. AdSense sets cookies and may use them for ad personalisation. Accept all, accept only what's needed, or read the <a href=\"#/privacy\">privacy page</a>.",
    "consent.min": "Necessary only",
    "consent.all": "Accept all",

    "privacy.s5.web.t": "Ads on this website",
    "privacy.s5.web.p": "This website uses <b>Google AdSense</b>. AdSense and its partners may set cookies on your device and use them to personalise ads, measure performance, and detect fraud. We don't run AdSense until you tap <em>Accept all</em> on the cookie banner. If you tap <em>Necessary only</em>, ads still appear but in a non-personalised form. You can change your choice by clearing site data for this domain.",
    "privacy.s5.app.t": "Ads in the mobile app",
    "privacy.s5.app.p": "The mobile app uses <b>Google Mobile Ads (AdMob)</b>. On first launch the app shows Google's official consent screen (via the <em>User Messaging Platform</em> SDK), where you can pick personalised, non-personalised, or — in regions where the choice is available — opt out. Ads keep the app free. We never use ads to collect your study answers or progress."
  },
  ...
  sv: {
    ...
    "qcard.q": "Vilken svensk princip ger alla rätt att gå, simma och plocka bär på det mesta av Sveriges mark?",
    ...
    "qcard.ex.b": "Allemansrätten",
    "qcard.ex.p": " — \"allas rätt\" — låter dig gå, simma, åka skidor, tälta och plocka bär på det mesta av Sveriges mark. Haken: var försiktig, hänsynsfull, och slå inte upp tältet i någons rabatt.",
    ...
    "faq.4.a": "Gratis att börja, gratis att göra provexempel, gratis för alltid för grundbanken på 500 frågor. Om vi någonsin lägger till premiumfunktioner blir det väldigt tydligt — svensk nivå av tydligt.",
    ...
    "faq.6.a": "Nej. Den aktuella byggen samlar inget och delar inget. Se <a href=\"#/privacy\">integritetssidan</a> för den fullt utskrivna, avsiktligt tråkiga versionen.",
    ...
    "privacy.lede": "Sveriges Medborgartest är en fristående studieapp. Vi ber inte om konto, kör ingen analytics och säljer ingenting. Den här sidan finns så att du kan verifiera allt det i text.",
    ...
    "privacy.s4.callout.p": "den aktuella MVP:n samlar inga användardata och delar inga användardata.",
    "privacy.s4.p": "Inga analytics-SDK:er. Inga kraschrapportörer som ringer hem. Inga tredjepartsspårare. Om en framtida bygge lägger till något som <em>faktiskt</em> pratar med en server uppdaterar vi sidan <em>innan</em> bygget släpps — och förändringen blir uppenbar, inte begravd i juridiska.",
    "privacy.s5.t": "Annonser och köp",
    "privacy.s5.p": "Den nativa bygget innehåller Google Mobile Ads testkonfiguration, men riktig annonsvisning är avstängd för v1.0-kandidaten. Om riktiga annonsförfrågningar, köp i appen, analytics, kraschrapportering eller support-SDK:er någonsin slås på kommer denna integritetspolicy, Apples integritetsetiketter, Google Play Datasäkerhet-svaren och integritets-texten i appen att granskas och uppdateras <em>innan</em> inlämning.",
    "privacy.s6.t": "Ändringar & kontakt",
    "privacy.s6.p": "Om policyn ändras uppdateras datumet längst upp. Frågor, oro, eller \"vad betyder det här egentligen?\" — gå till <a href=\"#/support\">supportsidan</a>.",
    ...
    "terms.lede": "Att använda appen innebär att du godkänner dessa villkor. De är korta med flit. Är något oklart är supportsidan ett tryck bort.",
    ...
    "terms.s3.p": "Frågor skrivs utifrån offentliga källor — Riksdagen, Skolverket, statistikrapporter — och granskas av människor. Människor missar saker. Hittar du fel är <a href=\"#/support\">supportsidan</a> snabbaste vägen.",
    ...
    "sources.lede": "Varje fråga i appen är grundad i en offentlig källa. Vi har ingen bakkanal till UHR. Vi läser noga och refererar tjatigt.",
    "sources.meta1.b": "Primära källor",
    "sources.meta1.v": "8",
    "sources.meta2.b": "Senaste översyn",
    "sources.meta2.v": "2026-05",
    "sources.meta3.b": "Öppna data",
    "sources.meta3.v": "CC-licens där möjligt",
    "sources.toc": "Kategorier",
    "sources.s1.t": "Stat & grundlag",
    "sources.s1.li1": "<b>Riksdagen</b> — de fyra grundlagarna, riksdagens arbete, valregler.",
    "sources.s1.li2": "<b>Regeringen.se</b> — regeringens struktur, ministerroller.",
    "sources.s1.li3": "<b>Migrationsverket</b> — medborgarskapskrav, uppehållstillstånd, den legala vägen.",
    "sources.s2.t": "Utbildning & samhällskunskap",
    "sources.s2.li1": "<b>Skolverket</b> — ramverk och kursplaner för samhällskunskap.",
    "sources.s2.li2": "<b>UHR</b> — myndigheten som administrerar det officiella provet. Endast offentlig dokumentation.",
    "sources.s3.t": "Statistik & fakta",
    "sources.s3.li1": "<b>SCB (Statistiska centralbyrån)</b> — demografi, befolkning, arbetsmarknad.",
    "sources.s3.li2": "<b>Folkhälsomyndigheten</b> — referenser för folkhälsa och välfärd.",
    "sources.s4.t": "Historia, geografi & kultur",
    "sources.s4.li1": "<b>Nationalencyklopedin</b> — historiska tidslinjer och biografier.",
    "sources.s4.li2": "<b>Institutet för språk och folkminnen</b> — traditioner, dialekter, kalenderbruk.",
    "sources.s5.t": "Redaktionell metod",
    "sources.s5.callout.b": "Husregel:",
    "sources.s5.callout.p": "om något inte kan refereras till en offentlig källa kommer det inte med i frågebanken.",
    "sources.s5.p": "Varje fråga går igenom utkast → källkoll → enkel-svenska-pass → granskning av modersmålstalare. När en källa uppdateras (nytt val, lagändring, omdöpt myndighet) får berörda frågor en refresh-tagg och går tillbaka till granskning.",
    ...
    "consent.body": "Vi använder Google AdSense för att visa ett par annonser. AdSense sätter cookies och kan använda dem för personalisering. Godkänn allt, bara det nödvändiga, eller läs <a href=\"#/privacy\">integritetssidan</a>.",
    "consent.min": "Bara nödvändiga",
    "consent.all": "Godkänn allt",

    "privacy.s5.web.t": "Annonser på webbplatsen",
    "privacy.s5.web.p": "Den här webbplatsen använder <b>Google AdSense</b>. AdSense och dess partner kan sätta cookies på din enhet och använda dem för personalisering, mätning och bedrägeridetektering. Vi kör inte AdSense förrän du trycker på <em>Godkänn allt</em>. Väljer du <em>Bara nödvändiga</em> visas annonserna icke-personaliserade. Du kan ändra valet genom att tömma platsdata för domänen.",
    "privacy.s5.app.t": "Annonser i mobilappen",
    "privacy.s5.app.p": "Mobilappen använder <b>Google Mobile Ads (AdMob)</b>. Vid första start visar appen Googles officiella samtyckesskärm (via <em>User Messaging Platform</em>-SDK:n) där du kan välja personaliserat, icke-personaliserat eller — där det går — avstå. Annonser håller appen gratis. Vi använder aldrig annonser för att samla in dina studiesvar eller framsteg."
  }
};
...
function smtGetConsent() {
  try { return localStorage.getItem("smt_consent"); } catch { return null; }
}
...
function smtShowAds(mode) {
  ...
  try { anchorDismissed = sessionStorage.getItem("smt_anchor_closed") === "1"; } catch {}
  ...
  native.forEach((el) => { el.hidden = !showNative; });
}
window.smtSetAdsMode = (mode) => {
  try { localStorage.setItem("smt_ads_mode", mode); } catch {}
  smtShowAds(mode);
};
window.smtGetAdsMode = () => {
  try { return localStorage.getItem("smt_ads_mode") || "both"; } catch { return "both"; }
};
window.smtRefreshAds = () => smtShowAds(window.smtGetAdsMode());

document.addEventListener("click", (e) => {
  if (e.target.closest("#consent-all")) {
    smtSetConsent("all"); smtHideConsent(); smtApplyConsent("all");
  } else if (e.target.closest("#consent-min")) {
    smtSetConsent("min"); smtHideConsent(); smtApplyConsent("min");
  } else if (e.target.closest("#ad-anchor-close")) {
    try { sessionStorage.setItem("smt_anchor_closed", "1"); } catch {}
...
const SMT_QUESTIONS = [
  {
    ...
    answer: 1,
    why: { en: "Allemansrätten — 'everyone's right' — lets you roam, swim, ski, camp, and forage on most land. The catch: be considerate.", sv: "Allemansrätten — 'allas rätt' — låter dig vandra, simma, åka skidor, tälta och plocka bär på det mesta av marken. Haken: var hänsynsfull." },
  },
  {
    ...
    answer: 2,
    why: { en: "The Riksdag is Sweden's parliament — 349 seats, four-year terms.", sv: "Riksdagen är Sveriges parlament — 349 platser, fyraåriga mandatperioder." },
  },
  {
    chapter: "Ch. 10 · EU & the world",
    q: { en: "When did Sweden join the European Union?", sv: "När gick Sverige med i Europeiska unionen?" },
    opts: [
      { en: "1973", sv: "1973" },
      { en: "1986", sv: "1986" },
      { en: "1995", sv: "1995" },
    ...
    answer: 2,
    why: { en: "Sweden joined the EU on January 1, 1995, alongside Austria and Finland.", sv: "Sverige gick med i EU den 1 januari 1995, tillsammans med Österrike och Finland." },
  },
  {
    chapter: "Ch. 2 · Government",
    ...
    answer: 3,
    why: { en: "Sweden is a constitutional monarchy. The King is head of state with purely ceremonial duties; the Prime Minister leads the government.", sv: "Sverige är en konstitutionell monarki. Kungen är statschef med rent ceremoniella uppgifter; statsministern leder regeringen." },
  },
  {
    chapter: "Ch. 3 · Rights",
    q: { en: "How many basic laws (grundlagar) does Sweden have?", sv: "Hur många grundlagar har Sverige?" },
    opts: [
      { en: "One", sv: "En" },
      { en: "Three", sv: "Tre" },
      { en: "Four", sv: "Fyra" },
    ...
    answer: 2,
    why: { en: "Four: Instrument of Government, Act of Succession, Freedom of the Press Act, Fundamental Law on Freedom of Expression.", sv: "Fyra: regeringsformen, successionsordningen, tryckfrihetsförordningen och yttrandefrihetsgrundlagen." },
  },
  {
    chapter: "Ch. 9 · Money",
    ...
    answer: 1,
    why: { en: "Sweden uses the krona (SEK). 1 krona = 100 öre, though öre coins are no longer in circulation.", sv: "Sverige använder kronan (SEK). 1 krona = 100 öre, men öremynt används inte längre." },
  },
  {
    ...
    answer: 1,
    why: { en: "June 6 marks Gustav Vasa's election as king in 1523 and the 1809 constitution. Public holiday since 2005.", sv: "Den 6 juni markerar Gustav Vasas val till kung 1523 och 1809 års regeringsform. Helgdag sedan 2005." },
  },
  {
    chapter: "Ch. 10 · EU & the world",
    ...
    answer: 3,
    why: { en: "Sweden formally joined NATO on March 7, 2024, ending more than two centuries of military non-alignment.", sv: "Sverige blev formellt NATO-medlem den 7 mars 2024 — slutet på över två sekler av militär alliansfrihet." },
  },
  {
    ...
    answer: 0,
    why: { en: "Skatteverket — also handles personnummer (the all-purpose Swedish ID), folkbokföring (residency registration), and ID cards.", sv: "Skatteverket — hanterar också personnummer, folkbokföring och ID-kort." },
  },
  {
    chapter: "Ch. 8 · Culture",
    q: { en: "Which holiday celebrates the summer solstice in Sweden?", sv: "Vilken högtid firar sommarsolståndet i Sverige?" },
    opts: [
    ...
    answer: 2,
    why: { en: "Midsommar — the Friday between June 19–25. Maypole, herring, snaps, and a flower crown if you're committed.", sv: "Midsommar — fredagen mellan 19–25 juni. Midsommarstång, sill, snaps och blomsterkrans om du satsar." },
  },
];
...
const SMT_QUIZ_COPY = {
  en: {
    ...
    verdict: (pct) =>
      pct === 100 ? "Lysande! That's a perfect round." :
      pct >= 80  ? "Strong. You're almost ready for the real thing." :
      pct >= 60  ? "Decent. A couple more rounds and you've got this." :
      pct >= 40  ? "Early days — that's fine. Practice again, the wrong ones come back." :
  ...
  sv: {
    ...
    verdict: (pct) =>
      pct === 100 ? "Lysande! En perfekt runda." :
      pct >= 80  ? "Starkt. Nästan redo för det riktiga." :
      pct >= 60  ? "Hyfsat. Ett par till och du sitter med det." :
      pct >= 40  ? "Tidigt — det är okej. Öva igen, fel-frågorna återkommer." :
...
function smtQuizReset() {
  SMT_QUIZ.i = 0; SMT_QUIZ.score = 0; SMT_QUIZ.answers = [];
  smtQuizRender();
}
  ...
  if (opt && !opt.hasAttribute("disabled")) {
    ...
    if (correct) {
      ...
      if (window.smtBuddyCelebrate) {
        if (streak >= 3) window.smtBuddyCelebrate(
          `${streak} in a row. Du är på gång.`,
          `${streak} i rad. Du är på gång.`
        );
        else window.smtBuddyCelebrate(
      ...
      if (window.smtBuddyConsole) window.smtBuddyConsole(
