...
const i18n = window.i18n = {
  en: {
    ...
    "sources.s3.li2": "This page stays aligned with the published question bank, so it lists only source families that appear on shipped question cards.",
    "sources.s4.t": "Current-source scope",
    "sources.s4.li1": "The bank currently uses only UHR material, based on <em>Sverige i fokus</em>.",
  ...
  sv: {
    ...
    "sources.s3.li2": "Den här sidan följer den publicerade frågebanken och listar bara källfamiljer som syns på publicerade frågekort.",
    "sources.s4.t": "Nuvarande källomfång",
    "sources.s4.li1": "Frågebanken bygger i dag bara på UHR-materialet från <em>Sverige i fokus</em>.",
