/* ------------------------------------------------------------------
   ...
   - language toggle (EN/SV plus static-site extras) with localStorage persistence
...
function smtDynamicI18nValue(key, lang) {
  ...
  return undefined;
function smtTextDirectionForLanguage(lang) {
  return lang === "ar" ? "rtl" : "ltr";
}

function smtTranslationFor(lang, key) {
  const langDict = i18n[lang] || i18n.en;
  if (langDict && langDict[key] !== undefined) return langDict[key];
  return i18n.en ? i18n.en[key] : undefined;
}

function applyLang(lang) {
  document.documentElement.lang = lang;
  document.documentElement.setAttribute("dir", smtTextDirectionForLanguage(lang));
  document.querySelectorAll("[data-i18n]").forEach((el) => {
    ...
    const value = smtTranslationFor(lang, key);
