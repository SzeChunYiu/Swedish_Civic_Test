...
const i18n = (window.i18n = {
  en: {
    ...
    'privacy.lede':
      "Sveriges Medborgartest is an independent study app. We don't ask for an account, and study progress stays local. This page explains the Google AdSense web ads, Google Mobile Ads app ads, and optional one-time Remove Ads purchase.",
    ...
    'privacy.s1.p':
      'Sveriges Medborgartest is an independent study app for Swedish civic knowledge practice. It is not official and is not affiliated with UHR, Skolverket, Migrationsverket, or the Swedish government. Anything you read here represents what <em>this app</em> does — nothing more.',
    ...
    'privacy.s5.p':
      "This website uses Google AdSense. The mobile app uses Google Mobile Ads (AdMob) behind Google's consent flow. Remove Ads is an optional one-time 29 SEK purchase. A validated purchase or restore stores a local purchase-status record with product ID, transaction ID or purchase token, and receipt-validation timestamp so ads can be removed. Ads help fund the free study experience, and ads never collect study answers or progress.",
  ...
  sv: {
    ...
    'privacy.lede':
      'Sveriges Medborgartest är en fristående studieapp. Vi ber inte om konto, och studieframsteg stannar lokalt. Den här sidan förklarar Google AdSense-annonser på webben, Google Mobile Ads i appen och det valfria engångsköpet Ta bort annonser.',
    ...
    'privacy.s1.p':
      'Sveriges Medborgartest är en fristående studieapp för övning av svensk samhällskunskap. Den är inte officiell och inte kopplad till UHR, Skolverket, Migrationsverket eller svenska staten. Allt du läser här gäller bara vad <em>denna app</em> gör — inget mer.',
    ...
    'privacy.s5.p':
      'Den här webbplatsen använder Google AdSense. Mobilappen använder Google Mobile Ads (AdMob) bakom Googles samtyckesflöde. Ta bort annonser är ett valfritt engångsköp på 29 SEK. Ett validerat köp eller en återställning sparar en lokal köpstatuspost med produkt-ID, transaktions-ID eller köptoken och tidpunkt för kvittovalidering så att annonser kan tas bort. Annonser hjälper till att finansiera den kostnadsfria studieupplevelsen, och annonser samlar aldrig in dina studiesvar eller framsteg.',
