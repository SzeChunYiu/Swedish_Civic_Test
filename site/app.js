...
const i18n = window.i18n = {
  en: {
    ...
    "faq.2.a": "It'll help you <em>study</em>. The result is still yours, the exam is UHR's, and fika can only do so much. We build practice from UHR's public study material and show citations so you can check the trail.",
  ...
  sv: {
    ...
    "faq.2.a": "Det hjälper dig att <em>plugga</em>. Resultatet är fortfarande ditt, provet är UHR:s och fika kan bara hjälpa till en bit. Vi bygger övningarna på UHR:s offentliga studiematerial och visar hänvisningar så att du kan kontrollera källorna.",
