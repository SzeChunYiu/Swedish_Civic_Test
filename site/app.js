...
const i18n = (window.i18n = {
  en: {
    ...
    "privacy.lede": "Almost Swedish is an independent study app. We don't ask for an account, and study progress stays local. This page explains the Google AdSense-ready web ad slots, Google Mobile Ads app ads, and optional one-time Remove Ads purchase.",
    ...
    'terms.s1.p':
      'Sveriges Medborgartest is an unofficial study app. It is not the exam, it is not run by UHR, Skolverket, Migrationsverket, or the Swedish government, and a perfect score here does not grant citizenship.',
    ...
    'sources.s5.p':
      'Every question goes through draft → source-check → plain-language pass → native-Swedish review before it ships. The cited source line is the contract: if a question disagrees with that public source, we fix the question or remove it.',
    'sources.s5.p2':
  ...
  sv: {
    ...
    'faq.4.a':
      'Gratis att börja, plugga och göra provexempel. Annonser hjälper oss hålla kärnfunktionerna tillgängliga; Ta bort annonser är ett valfritt engångsköp på 29 SEK. Ett validerat köp eller en återställning sparar en lokal köpstatuspost med produkt-ID, transaktions-ID eller köptoken och tidpunkt för kvittovalidering så att annonser kan tas bort.',
    ...
    'terms.s1.p':
      'Sveriges Medborgartest är en inofficiell studieapp. Det är inte provet, det drivs inte av UHR, Skolverket, Migrationsverket eller svenska staten, och full pott här ger inte medborgarskap.',
    ...
    "privacy.s5.web.p": "Den här webbplatsen är förberedd för <b>Google AdSense</b>, men den statiska versionen laddar inte AdSense förrän granskade webbplats-ID:n är konfigurerade. När AdSense är aktiverat kan AdSense och dess partner sätta cookies på din enhet och använda dem för personalisering, mätning och bedrägeridetektering. Vi laddar AdSense enligt ditt cookieval: <em>Godkänn allt</em> tillåter personaliserade annonser, medan <em>Bara nödvändiga</em> håller annonserna icke-personaliserade. Du kan ändra valet genom att tömma platsdata för domänen.",
