...
const i18n = (window.i18n = {
  en: {
    ...
    'faq.4.q': 'Is it free?',
    'faq.4.a':
      'Free to start, free to study, and free to take mock exams. Ads help keep the core app available; Remove Ads is an optional one-time 29 SEK purchase. A validated purchase or restore stores a local purchase-status record with product ID, transaction ID or purchase token, and receipt-validation timestamp so ads can be removed.',
