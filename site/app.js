...
const i18n = window.i18n = {
  en: {
    ...
    "sources.s2.li2": "Each question's visible source line names the same source title, chapter, section, and page learners can check.",
  ...
  sv: {
    ...
    "sources.s2.li2": "Varje frågas synliga källrad anger källtitel, kapitel, avsnitt och sida som går att kontrollera.",
