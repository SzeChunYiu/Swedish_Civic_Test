...
const i18n = window.i18n = {
  en: {
    ...
    "demo.li3": "<b>Mock exam mode</b> with a timer and no instant hints, so practice feels focused.",
    ...
    "chap.12.d": "Timed practice rounds with review cards and a what-to-bring checklist.",
    ...
    "how.s3.t": "Mock exam — timed practice",
    "how.s3.p": "Practice with a timer, answer navigation, and review afterwards. It is still unofficial study practice.",
  ...
  sv: {
    ...
    "demo.li3": "<b>Provläge</b> med timer och utan direkta ledtrådar, så övningen blir fokuserad.",
    ...
    "chap.12.d": "Tidsatta övningspass med genomgång efteråt och en kort packlista.",
    ...
    "how.s3.t": "Provexempel — tidsatt övning",
    "how.s3.p": "Öva med timer, frågenavigering och genomgång efteråt. Det är fortfarande inofficiell övning.",
...
const SMT_QUIZ_COPY = {
  en: {
    ...
    verdict: (pct) =>
      ...
      pct >= 80  ? "Strong. Keep reviewing the official sources and your weak chapters." :
  ...
  sv: {
    ...
    verdict: (pct) =>
      ...
      pct >= 80  ? "Starkt. Fortsätt repetera källorna och dina svaga kapitel." :
