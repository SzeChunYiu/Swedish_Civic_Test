...
(function () {
  ...
  function questionTags(question) {
    return Array.isArray(question && question.tags) ? question.tags : [];
  }
  function questionProvenance(question) {
    if (question && typeof question.questionProvenance === "string") return question.questionProvenance;
    if (question && typeof question.provenance === "string") return question.provenance;
  ...
  function renderMockLanding() {
    ...
    const maxQ = Math.min(60, mockQuestionPool().filter((q) => {
