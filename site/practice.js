    ...
    stage.innerHTML = `
      <div class="mock-landing">
        <div class="mock-landing__inner">
          <span class="eyebrow">${sv ? 'Övningsprov' : 'Timed practice'}</span>
          ...
          <p class="mock-landing__lede">${
            sv
              ...
              : "Pick the question count, timer, and which chapters to include. We'll shuffle the rest."
          }</p>
  ...
  function renderMockResult() {
    ...
    const reviewRows = MOCK.questions
      .map((q, i) => {
        ...
        const selectedText =
          picked === null ? (sv ? 'Inte besvarad' : 'Not answered') : tr(q.opts[picked]);
