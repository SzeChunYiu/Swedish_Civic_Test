...
(function () {
  const T = {
    ...
    'signin.fineprint': {
      en: 'No password needed. We never post anything or sell your study data. Account sync uses Supabase or your sign-in provider only for account-backed features.',
      sv: 'Inget lösenord behövs. Vi publicerar aldrig något och säljer inte dina studiedata. Kontosynk använder Supabase eller din inloggningsleverantör bara för kontofunktioner.',
      'zh-Hans':
        '无需密码。我们绝不会发布任何内容，也不会出售你的学习数据。账户同步只会为账户功能使用 Supabase 或你的登录提供方。',
      'zh-Hant':
        '不需要密碼。我們絕不會發布任何內容，也不會出售你的學習資料。帳號同步只會為帳號功能使用 Supabase 或你的登入提供方。',
      ar: 'لا حاجة لكلمة مرور. لا ننشر أي شيء ولا نبيع بيانات دراستك. تستخدم مزامنة الحساب Supabase أو مزوّد تسجيل الدخول فقط لميزات الحساب.',
      ckb: 'پێویست بە تێپەڕەوشە نییە. هیچ شتێک بڵاو ناکەینەوە و داتای خوێندنت نافرۆشین. هاوکاتکردنی هەژمار تەنها بۆ تایبەتمەندییەکانی هەژمار Supabase یان دابینکەری چوونەژوورەوەت بەکاردەهێنێت.',
      fa: 'نیازی به رمز عبور نیست. ما هرگز چیزی منتشر نمی‌کنیم و داده‌های مطالعه‌ات را نمی‌فروشیم. همگام‌سازی حساب فقط برای قابلیت‌های حساب از Supabase یا ارائه‌دهنده ورودت استفاده می‌کند.',
      pl: 'Hasło nie jest potrzebne. Niczego nie publikujemy ani nie sprzedajemy Twoich danych nauki. Synchronizacja konta używa Supabase lub dostawcy logowania tylko do funkcji konta.',
      so: 'Furaha sirta looma baahna. Waxba ma daabacno mana iibino xogtaada waxbarasho. Isku-xirka akoonku wuxuu Supabase ama bixiyaha gelitaanka u adeegsadaa oo keliya hawlaha akoonka.',
      ti: 'መሕለፊ ቃል ኣየድልን። ዝኾነ ነገር ኣይነዝርግሕን ሓበሬታ መጽናዕትኻ ኣይንሸጥን። ምስንካር ሕሳብ ንባህርያት ሕሳብ ጥራይ Supabase ወይ ናይ ምእታው ኣቕራቢኻ ይጥቀም።',
      tr: 'Şifre gerekmez. Asla bir şey yayımlamayız veya çalışma verilerini satmayız. Hesap senkronizasyonu, hesap özellikleri için yalnızca Supabase ya da giriş sağlayıcını kullanır.',
      uk: 'Пароль не потрібен. Ми ніколи нічого не публікуємо й не продаємо ваші навчальні дані. Синхронізація облікового запису використовує Supabase або вашого провайдера входу лише для функцій облікового запису.',
    },
    'signin.magicsent': {
