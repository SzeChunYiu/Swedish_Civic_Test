...
(function () {
  const T = {
    ...
    'signin.lede': {
      en: 'Save your highlights, notes, and progress across devices. Totally optional — the core study flow works without sign-in.',
      sv: 'Spara dina markeringar, anteckningar och framsteg på alla enheter. Helt valfritt — själva studieflödet fungerar utan inloggning.',
      'zh-Hans': '跨设备保存你的标注、笔记和学习进度。完全可选——核心学习流程无需登录也能使用。',
      'zh-Hant': '跨裝置儲存你的標註、筆記和學習進度。完全可選——核心學習流程無需登入也能使用。',
      ar: 'احفظ تظليلاتك وملاحظاتك وتقدّمك عبر كل أجهزتك. اختياري تمامًا — يعمل مسار الدراسة الأساسي بدون تسجيل الدخول.',
      ckb: 'هایلایت، تێبینی و پێشکەوتنەکانت لەسەر هەموو ئامێرەکان پاشەکەوت بکە. تەواو ئیختیارییە — ڕەوتی سەرەکی خوێندن بێ چوونەژوورەوە کار دەکات.',
      fa: 'هایلایت‌ها، یادداشت‌ها و پیشرفتت را روی همه دستگاه‌ها ذخیره کن. کاملاً اختیاری — مسیر اصلی مطالعه بدون ورود هم کار می‌کند.',
      pl: 'Zapisuj zaznaczenia, notatki i postępy na wszystkich urządzeniach. Całkowicie opcjonalne — podstawowa nauka działa bez logowania.',
      so: 'Kaydi calaamadahaaga, qoraalladaada iyo horumarkaaga dhammaan qalabkaaga. Gabi ahaanba ikhtiyaari — socodka waxbarashada aasaasiga ah wuu shaqeeyaa adigoon soo gelin.',
      ti: 'ምልክታትካ፣ መዘኻኸርን ምዕባለኻን ኣብ ኩሎም መሳርሕታት ኣቐምጥ። ምሉእ ብምሉእ ኣማራጺ — መሰረታዊ መጽናዕቲ ብዘይ ምእታው ይሰርሕ።',
      tr: 'Vurgularını, notlarını ve ilerlemeni tüm cihazlarda kaydet. Tamamen isteğe bağlı — temel çalışma akışı giriş yapmadan çalışır.',
      uk: "Зберігайте свої виділення, нотатки та прогрес на всіх пристроях. Цілком необов'язково — основний навчальний сценарій працює без входу.",
    },
    'signin.google': {
