  ...
  const CHAPTERS = {
    ...
    12: {
      ...
      lede: {
        ...
        sv: 'Använd provexemplet för övning, men håll praktiska provdetaljer knutna till UHR och Migrationsverket.',
      },
      body: {
        en: `
        ...
        sv: `
          ...
          <ol>
            ...
            <li>Använd provexemplet här för blandad repetition och gå tillbaka till kapitlen där du tappade poäng.</li>
          </ol>
