  ...
  const CHAPTERS = {
    intro: {
      ...
      lede: {
        ...
        sv: 'Det här är ett sällskap, inte en lärobok. Läs ett kapitel, gör ett kort övningspass, ta en fika. Ordningen spelar mindre roll — men i ordning får du en känsla för hur Sveriges delar passar ihop.',
      },
      body: {
        en: `
