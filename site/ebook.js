...
(function () {
    ...
    12: {
      ...
      body: {
        ...
        'zh-Hans': `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>公民知识考试本身只能用瑞典语参加。这与之后引入的瑞典语语言考试是分开的。</p>
          ...
          <div class="ebook__factbox"><h4>当前来源说明</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>来源访问于 2026-05-19：${officialTestSourceLinks('zh-Hans')}</p></div>
        `,
        'zh-Hant': `
          <h2>當前的官方狀態</h2>
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>公民知識考試本身只能用瑞典語參加。這與之後引入的瑞典語語言考試是分開的。</p>
          ...
          <div class="ebook__factbox"><h4>當前來源說明</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>來源存取於 2026-05-19：${officialTestSourceLinks('zh-Hant')}</p></div>
        `,
        ar: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>لا يمكن أداء اختبار المعرفة المدنية نفسه إلا باللغة السويدية. وهذا منفصل عن اختبارات اللغة السويدية التي ستُقدَّم لاحقًا.</p>
          ...
          <div class="ebook__factbox"><h4>ملاحظات المصادر الحالية</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>المصادر تمّ الاطلاع عليها 2026-05-19: ${officialTestSourceLinks('ar')}</p></div>
        `,
        ckb: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>خودی تاقیکردنەوەی زانیاریی شارۆمەندی تەنها بە زمانی سویدی دەکرێت. ئەمە جیاوازە لە تاقیکردنەوەکانی زمانی سویدی کە دواتر دەست پێ دەکەن.</p>
          ...
          <div class="ebook__factbox"><h4>تێبینییەکانی سەرچاوەی ئێستا</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>سەرچاوەکان سەردانیان کراوە 2026-05-19: ${officialTestSourceLinks('ckb')}</p></div>
        `,
        fa: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>خود آزمون دانش مدنی فقط به زبان سوئدی برگزار می‌شود. این موضوع از آزمون‌های زبان سوئدی که بعداً معرفی می‌شوند جداست.</p>
          ...
          <div class="ebook__factbox"><h4>یادداشت‌های منابع کنونی</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>منابع در 2026-05-19 بازدید شده‌اند: ${officialTestSourceLinks('fa')}</p></div>
        `,
        pl: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>Sam test wiedzy obywatelskiej można zdawać tylko po szwedzku. To jest oddzielne od testów języka szwedzkiego, które zostaną wprowadzone później.</p>
          ...
          <div class="ebook__factbox"><h4>Bieżące uwagi o źródłach</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>Źródła otwarte 2026-05-19: ${officialTestSourceLinks('pl')}</p></div>
        `,
        so: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>Imtixaanka aqoonta madaniga laftiisa waxaa lagu qaadan karaa oo keliya af Iswiidhish. Taasi way ka duwan tahay imtixaannada luqadda Iswiidhishka ee dambe la bilaabayo.</p>
          ...
          <div class="ebook__factbox"><h4>Xusuusyada ilaha ee hadda</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>Ilaha la galay 2026-05-19: ${officialTestSourceLinks('so')}</p></div>
        `,
        ti: `
          <h2>ህሉው ወግዓዊ ኩነታት</h2>
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>እቲ ናይ ሲቪክ ፍልጠት ፈተና ባዕሉ ብሽወደንኛ ጥራይ ክውሰድ ይኽእል። እዚ ካብቶም ድሒሮም ዝኣትዉ ናይ ሽወደንኛ ቋንቋ ፈተናታት ዝተፈልየ እዩ።</p>
          ...
          <div class="ebook__factbox"><h4>ህሉዋት ናይ ምንጪ መግለጺታት</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>ምንጪታት ዝተበጽሑ 2026-05-19: ${officialTestSourceLinks('ti')}</p></div>
        `,
        tr: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>Vatandaşlık bilgisi sınavının kendisi yalnızca İsveççe yapılabilir. Bu, daha sonra uygulanacak İsveççe dil sınavlarından ayrıdır.</p>
          ...
          <div class="ebook__factbox"><h4>Güncel kaynak notları</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>Kaynaklara erişim 2026-05-19: ${officialTestSourceLinks('tr')}</p></div>
        `,
        uk: `
          ...
          <p${ebookSourceKeyDataAttr(OFFICIAL_TEST_LANGUAGE_SOURCE_KEYS)}>Сам тест із громадянських знань можна складати лише шведською мовою. Це окремо від тестів зі шведської мови, які запровадять пізніше.</p>
          ...
          <div class="ebook__factbox"><h4>Поточні примітки до джерел</h4><p${ebookSourceKeyDataAttr(OFFICIAL_TEST_SOURCE_KEYS)}>Джерела відкрито 2026-05-19: ${officialTestSourceLinks('uk')}</p></div>
        `,
      },
    },
    13: {
  ...
  const PRACTICE_LINKS = {
    intro: {
      ...
      'zh-Hant': '開始練習',
      ar: 'ابدأ التدريب',
      ckb: 'دەست بە ڕاهێنان بکە',
      fa: 'تمرین را شروع کنید',
      pl: 'Rozpocznij ćwiczenie',
      so: 'Bilow tababarka',
      ti: 'ልምምድ ጀምር',
      tr: 'Alıştırmaya başlayın',
    ...
    1: {
      ...
      'zh-Hans': '练习历史',
      'zh-Hant': '練習歷史',
      ar: 'تدرّب على التاريخ',
      ckb: 'لەسەر مێژوو ڕاهێنان بکە',
      fa: 'تاریخ را تمرین کنید',
      pl: 'Ćwicz historię',
      so: 'Ku tababar taariikhda',
      ti: 'ታሪኽ ተለማመድ',
      tr: 'Tarih alıştırması yap',
      uk: 'Тренувати історію',
    },
    2: {
      href: '#/practice?c=3',
      en: 'Practice government',
      sv: 'Öva statsskick',
      'zh-Hans': '练习政体',
      'zh-Hant': '練習政體',
      ar: 'تدرّب على نظام الحكم',
      ckb: 'لەسەر سیستەمی حوکمڕانی ڕاهێنان بکە',
      fa: 'نظام حکمرانی را تمرین کنید',
      pl: 'Ćwicz ustrój państwa',
      so: 'Ku tababar nidaamka maamulka',
      ti: 'ስርዓተ መንግስቲ ተለማመድ',
      tr: 'Yönetim sistemi alıştırması yap',
      uk: 'Тренувати державний устрій',
    },
    3: {
      href: '#/practice?c=5',
      en: 'Practice rights',
      ...
      'zh-Hant': '練習權利',
      ar: 'تدرّب على الحقوق',
      ckb: 'لەسەر مافەکان ڕاهێنان بکە',
      fa: 'حقوق را تمرین کنید',
      pl: 'Ćwicz prawa',
      so: 'Ku tababar xuquuqda',
      ti: 'መሰላት ተለማመድ',
      tr: 'Haklar alıştırması yap',
      uk: 'Тренувати права',
    },
    4: {
      href: '#/practice?c=8',
      en: 'Practice work and money',
      sv: 'Öva arbete och ekonomi',
      'zh-Hans': '练习工作与经济',
      'zh-Hant': '練習工作與經濟',
      ar: 'تدرّب على العمل والاقتصاد',
      ckb: 'لەسەر کار و ئابووری ڕاهێنان بکە',
      fa: 'کار و اقتصاد را تمرین کنید',
      pl: 'Ćwicz pracę i ekonomię',
      so: 'Ku tababar shaqada iyo dhaqaalaha',
      ti: 'ስራን ቁጠባን ተለማመድ',
      tr: 'İş ve ekonomi alıştırması yap',
      uk: 'Тренувати працю й економіку',
    },
    5: {
      href: '#/practice?c=7',
      en: 'Practice equality',
      sv: 'Öva jämställdhet',
      'zh-Hans': '练习平等',
      'zh-Hant': '練習平等',
      ar: 'تدرّب على المساواة',
      ckb: 'لەسەر یەکسانی ڕاهێنان بکە',
      fa: 'برابری را تمرین کنید',
      pl: 'Ćwicz równość',
      so: 'Ku tababar sinnaanta',
      ti: 'ማዕርነት ተለማመድ',
      tr: 'Eşitlik alıştırması yap',
      uk: 'Тренувати рівність',
    },
    6: {
      href: '#/practice?c=9',
      en: 'Practice welfare',
      ...
      'zh-Hant': '練習福利',
      ar: 'تدرّب على الرفاه',
      ckb: 'لەسەر خۆشگوزەرانی ڕاهێنان بکە',
      fa: 'رفاه را تمرین کنید',
      pl: 'Ćwicz system opieki społecznej',
      so: 'Ku tababar daryeelka bulshada',
      ti: 'ድሕነት ሕብረተሰብ ተለማመድ',
      tr: 'Refah sistemi alıştırması yap',
      uk: 'Тренувати соціальний захист',
    },
    7: {
      href: '#/practice?c=1',
      en: 'Practice nature',
      ...
      'zh-Hans': '练习自然',
      'zh-Hant': '練習自然',
      ar: 'تدرّب على الطبيعة',
      ckb: 'لەسەر سروشت ڕاهێنان بکە',
      fa: 'طبیعت را تمرین کنید',
      pl: 'Ćwicz przyrodę',
      so: 'Ku tababar dabeecadda',
      ti: 'ተፈጥሮ ተለማመድ',
      tr: 'Doğa alıştırması yap',
      uk: 'Тренувати природу',
    },
    8: {
      href: '#/practice?c=13',
      en: 'Practice traditions',
      sv: 'Öva traditioner',
      'zh-Hans': '练习传统',
      'zh-Hant': '練習傳統',
      ar: 'تدرّب على التقاليد',
      ckb: 'لەسەر نەریتەکان ڕاهێنان بکە',
      fa: 'سنت‌ها را تمرین کنید',
      pl: 'Ćwicz tradycje',
      so: 'Ku tababar caadooyinka',
      ti: 'ልምድታት ተለማመድ',
      tr: 'Gelenekler alıştırması yap',
      uk: 'Тренувати традиції',
    },
    9: {
      href: '#/practice?c=8',
      en: 'Practice money',
      ...
      'zh-Hant': '練習金錢與銀行',
      ar: 'تدرّب على المال',
      ckb: 'لەسەر پارە ڕاهێنان بکە',
      fa: 'پول را تمرین کنید',
      pl: 'Ćwicz finanse',
      so: 'Ku tababar lacagta',
      ti: 'ገንዘብ ተለማመድ',
      tr: 'Para konusunu çalış',
      uk: 'Тренувати фінанси',
    },
    10: {
      href: '#/practice?c=11',
      en: 'Practice EU and world',
      sv: 'Öva EU och omvärld',
      'zh-Hans': '练习欧盟与世界',
      'zh-Hant': '練習歐盟與世界',
      ar: 'تدرّب على الاتحاد الأوروبي والعالم',
      ckb: 'لەسەر یەکێتیی ئەوروپا و جیهان ڕاهێنان بکە',
      fa: 'اتحادیه اروپا و جهان را تمرین کنید',
      pl: 'Ćwicz UE i świat',
      so: 'Ku tababar Midowga Yurub iyo dunida',
      ti: 'ኤዩን ዓለምን ተለማመድ',
      tr: 'AB ve dünya alıştırması yap',
      uk: 'Тренувати ЄС і світ',
    },
    11: {
      href: '#/practice?c=mix',
      en: 'Practice mixed questions',
      sv: 'Öva blandade frågor',
      'zh-Hans': '练习混合题',
      'zh-Hant': '練習混合題',
      ar: 'تدرّب على أسئلة مختلطة',
      ckb: 'لەسەر پرسیاری تێکەڵاو ڕاهێنان بکە',
      fa: 'سؤال‌های ترکیبی را تمرین کنید',
      pl: 'Ćwicz pytania mieszane',
      so: 'Ku tababar su’aalo isku dhafan',
      ti: 'ሕቶታት ዝተሓዋወሱ ተለማመድ',
      tr: 'Karışık sorularla alıştırma yap',
      uk: 'Тренувати змішані питання',
    },
    12: {
      href: '#/mock',
      en: 'Start mock exam',
      ...
      'zh-Hans': '开始模拟考试',
      'zh-Hant': '開始模擬測驗',
      ar: 'ابدأ الاختبار التجريبي',
      ckb: 'دەست بە تاقیکردنەوەی ئەزموونی بکە',
      fa: 'آزمون آزمایشی را شروع کنید',
      pl: 'Rozpocznij test próbny',
      so: 'Bilow imtixaanka tijaabada ah',
      ti: 'ፈተና ልምምድ ጀምር',
      tr: 'Deneme sınavını başlatın',
      uk: 'Почати пробний іспит',
    },
    13: {
      href: '#/practice?c=13',
      en: 'Practice traditions',
