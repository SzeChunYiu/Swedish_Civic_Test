...
const SMT_SLOGANS = {
  midsommar: { a: "Study the basics.", b: "Practice with sources.", c: "Brag about progress." },
  abba:      { a: "Take a chance.", b: "Mamma mia, study.", c: "Practice like a dancing queen." },
  fika:      { a: "Sip the coffee.", b: "Open the app.",     c: "Review one more card." },
