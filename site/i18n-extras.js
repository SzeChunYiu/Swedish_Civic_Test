...
(function () {
  ...
  const extra = {
    ...
    "zh-Hans": {
      ...
      "hero.h1b": "循序练习。",
      "hero.h1c": "更懂瑞典。",
      "hero.lede": "一个安静的非官方学习应用,帮助你准备瑞典公民知识内容。简短章节、智能练习和模拟考,让复习更清楚、更有节奏。",
      "hero.cta1": "开始练习 →",
      "hero.cta2": "随便试一题",
    ...
    "zh-Hant": {
      ...
      "hero.h1b": "循序練習。",
      "hero.h1c": "更懂瑞典。",
      "hero.lede": "一個安靜的非官方學習應用,幫助你準備瑞典公民知識內容。簡短章節、智慧練習和模擬考,讓複習更清楚、更有節奏。",
      "hero.cta1": "開始練習 →",
      "hero.cta2": "隨便試一題",
    ...
    "so": {
      ...
      "hero.h1a": "Si deggan u baro.",
      "hero.h1b": "Ku tababar tallaabo tallaabo.",
