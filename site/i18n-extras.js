...
(function () {
  ...
  const extra = {
    ...
    "ar": {
      ...
      "hero.eyebrow": "تطبيق مستقل للدراسة لاختبار المواطنة السويدي",
      "hero.h1a": "اجتز الاختبار.",
      "hero.h1b": "احصل على جواز السفر.",
      "hero.h1c": "تباهَ في عيد منتصف الصيف.",
      "hero.lede": "تطبيق دراسة هادئ ومستقل لاختبار المواطنة السويدي. فصول قصيرة، وتدريب ذكي، واختبار تجريبي يساعدك على استقبال يوم الاختبار بثقة أكبر.",
      ...
      "settings.palette.sub": "اختر طابعاً سويدياً.",
      ...
      "settings.consent.reset": "إعادة ضبط موافقة ملفات تعريف الارتباط والإعلانات…",
      ...
      "footer.fika": "صُنع بعناية · وجُرّب أثناء استراحة قهوة.",
    },
