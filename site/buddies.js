...
(function () {
  ...
  const GREETINGS = Object.freeze({
    ...
    sv: [
      ...
      'Välkommen. {name} här. Klicka, jag har saker att säga.',
    ],
  });

  const PAGE_NUDGES = Object.freeze({
    '/practice': {
  ...
  function fillBuddyTemplate(text, buddy) {
    return String(text).replace(/\{name\}/g, buddy.name);
  }
  ...
  const BUDDIES = [
    {
      ...
      tips: {
        en: [
          ...
          'When two answers feel close, read the question again. The clue is usually doing paperwork in plain sight.',
        ...
        sv: [
          ...
          'När två svar känns nära, läs frågan igen. Ledtråden brukar stå där och se upptagen ut.',
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Lagom finns inte på provet. Men det borde göra det.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Vi är ungefär 300 000. Får du fler rätt än så är jag imponerad.',
          'Älgar kan springa 60 km/h. Du kan klara ett tiominuterskapitel.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        en: [
          ...
          'I never touch answer letters. I just stare until you read the explanation.',
        ...
        sv: [
          ...
          'Jag rör aldrig svarsbokstäver. Jag stirrar bara tills du läser förklaringen.',
          'Känns något för lätt, så är det oftast det.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Låt inte surströmming representera oss. Vi luktar inte alla.',
          'Midsommarbord utan mig är bara en ledsen tallrik.',
          'Om frågan nämner sill eller strömming är det nog inte samhällskunskapsprovet. Troligen.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Jag toppade vid 200 mg. Du gör det bra på vatten också.',
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Jag bor på museum nu. Folk betalar för att se mig. Även misslyckanden kan göra comeback.',
          'Sjunker första försöket, lägg till vid kaj i 333 år och prova igen.',
          'Vasamuseet är Sveriges mest besökta museum. Ta med barnen.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Midsommar är alltid en fredag mellan 19 och 25 juni. Festen är obligatorisk.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Sjung tyst om du måste. Grannen pluggar också.',
          'Saffran hör till bullarna, inte provet.',
          'Lucia är 13 december. Skriv upp: mörker plus ljus.',
        ],
      },
      pet: {
...

    {
      ...
      tips: {
        ...
        sv: [
          ...
          'Byggd på 5 minuter. Pluggat i 6. Du ligger redan före.',
          'Vintern är hård. Vintern är också när svenskar pluggar som bäst.',
        ],
      },
      pet: {
...
<line x1="62" y1="54" x2="78" y2="46" stroke="#6b4520" stroke-width="2"/></svg>`,
  ...
  function showGreeting() {
    ...
    showMessage(fillBuddyTemplate(list[Math.floor(Math.random() * list.length)], b));
  }
  ...
  function pageNudge() {
    ...
    const lang = currentLang();
    if (PAGE_NUDGES[path]) {
      showMessage(fillBuddyTemplate(PAGE_NUDGES[path][lang] || PAGE_NUDGES[path].en, b));
    }
  }
  ...
  window.smtBuddyCopyManifest = () => ({
    facts: SMT_FACTS.map((fact) => ({ en: fact.en, sv: fact.sv })),
    greetings: GREETINGS,
    pageNudges: PAGE_NUDGES,
    buddies: BUDDIES.map((b) => ({
      id: b.id,
      factPrefix: b.factPrefix,
      pet: b.pet,
      tips: b.tips,
    })),
  });
