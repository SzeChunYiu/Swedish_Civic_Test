  ...
  const BUDDIES = [
    {
      ...
      tips: {
        en: [
          ...
          "If two options feel close, use the explanation after you answer. No pattern tricks required.",
        ...
        sv: [
          ...
          "Om två alternativ känns nära, använd förklaringen efteråt. Inga mönsterknep behövs.",
