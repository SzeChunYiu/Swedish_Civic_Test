...
test('static ebook prose provenance is footnoted from concrete source metadata', () => {
  ...
  assert.match(ebookSource, /UHR:s offentliga utbildningsmaterial/);
  ...
  assert.match(ebookSource, /Riksbankens historiska tidslinje/);
  assert.match(ebookSource, /Government Offices NATO membership notice/);
  assert.match(ebookSource, /Regeringskansliets besked om Nato-medlemskap/);
