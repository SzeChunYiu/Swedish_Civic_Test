...
test('full content production validates published UHR-referenced questions', () => {
  ...
  assert.equal(summary.staticSiteSwedishStreakCopyNaturalnessValidated, true);
  ...
  assert.equal(summary.staticSiteSwedishCopyLoanwordPatternsValidated, 5);
  assert.equal(summary.staticSiteSwedishCopyLoanwordNaturalnessValidated, true);
