...
const FOCUSED_VALIDATION_REGISTRY = Object.freeze([
  ...
  {
    id: 'topBarActionsAccessibility',
    flags: ['--focus-topbar-actions-accessibility'],
    summaryKeys: [
  ...
  {
    id: 'questionSourceCitationAccessibility',
    flags: ['--focus-question-source-citation-accessibility'],
    summaryKeys: [
