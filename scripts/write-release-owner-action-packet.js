...
const ownerActions = {
  ...
  'privacy-review': {
    ...
    neededEvidence:
      'Reviewed build ID/version/commit, Apple privacy labels, Google Play Data safety, current Google Mobile Ads real-ad posture, concrete AdMob app/unit IDs, app-ads.txt review, ATT/UMP consent, and 29 SEK Remove Ads IAP review.',
