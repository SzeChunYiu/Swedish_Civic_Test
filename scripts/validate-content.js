...
const EXPECTED_PRACTICE_ROUTE_COPY_SNIPPETS = [
  ...
  [
    ...
    'practice route must import the storage warning notice',
  ],
  [
    'const progressPersistenceWarning = useProgressStore((state) => state.persistenceWarning);',
    'practice route must read progress persistence warnings',
  ],
  [
    'const clearProgressPersistenceWarning = useProgressStore(',
    'practice route must expose progress warning dismissal',
  ],
  [
    'const mistakeReviewPersistenceWarning = useMistakeReviewStore(',
    'practice route must read mistake-review persistence warnings',
  ],
  [
    'const clearMistakeReviewPersistenceWarning = useMistakeReviewStore(',
    'practice route must expose mistake-review warning dismissal',
  ],
  ['<PersistenceWarningNotice', 'practice route must render storage warning notices'],
...
const EXPECTED_MISTAKES_ROUTE_COPY_SNIPPETS = [
  ...
  [
    "import { PersistenceWarningNotice } from '../../components/storage/PersistenceWarningNotice';",
    'mistakes route must import the storage warning notice',
  ],
  [
    'const progressPersistenceWarning = useProgressStore((state) => state.persistenceWarning);',
    'mistakes route must read progress persistence warnings',
  ],
  [
    'const clearProgressPersistenceWarning = useProgressStore(',
    'mistakes route must expose progress warning dismissal',
  ],
  [
    'const mistakeReviewPersistenceWarning = useMistakeReviewStore(',
    'mistakes route must read mistake-review persistence warnings',
  ],
  [
    'const clearMistakeReviewPersistenceWarning = useMistakeReviewStore(',
    'mistakes route must expose mistake-review warning dismissal',
  ],
  ['<PersistenceWarningNotice', 'mistakes route must render storage warning notices'],
...
const EXPECTED_SETTINGS_ROUTE_COPY_SNIPPETS = [
  ...
  [
    "import { PersistenceWarningNotice } from '../components/storage/PersistenceWarningNotice';",
    'settings route must import the storage warning notice',
  ],
  [
    'const persistenceWarning = useSettingsStore((state) => state.persistenceWarning);',
    'settings route must read settings persistence warnings',
  ],
  [
    'const clearPersistenceWarning = useSettingsStore((state) => state.clearPersistenceWarning);',
    'settings route must expose warning dismissal',
  ],
  ['<PersistenceWarningNotice', 'settings route must render storage warning notices'],
  [
...
function validateSettingsStoreSchemaParity() {
  ...
  const requiredSnippets = [
    [
      ...
      'settings storage must define the stable settings MMKV id',
    ],
    [
    ...
    ['persistenceWarning: null', 'SettingsState must initialize with no persistence warning'],
    [
    ...
    [
      ...
      'settings store must expose warning dismissal',
    ],
  ];
...
function validateSettingsAudioParity() {
  ...
  if (
    ...
    reject('setAudioEnabled must persist audioEnabled through audioEnabledKey recoverably');
  }
...
function validateProgressStoreSchemaParity() {
  ...
  const requiredSnippets = [
    [
      ...
      'progress storage must define the stable progress MMKV id',
    ],
    [
    ...
    ['persistenceWarning: null', 'ProgressState must initialize with no persistence warning'],
    [
      'writeRecoverably( progressStorage, progressStorageId, progressStateKey, JSON.stringify(progress), )',
      'writeProgress must persist JSON through progressStateKey recoverably',
    ],
    [
    ...
    [
      'clearPersistenceWarning: () => set({ persistenceWarning: null })',
      'progress store must expose warning dismissal',
    ],
  ];
