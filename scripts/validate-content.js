...
const EXPECTED_EXAM_ROUTE_HEADERS = [
  ...
  {
    label: 'reward preview title',
    pattern: /\{copy\.rewardPreviewTitle\}/,
    styleName: 'rewardPreviewTitle',
    occurrences: 1,
  },
  {
...
const EXPECTED_EXAM_ROUTE_COPY_SNIPPETS = [
  ...
  ['{copy.rewardPreviewTitle}', 'exam reward preview title must render localized copy'],
  ['{copy.rewardPreviewBody}', 'exam reward preview body must render localized copy'],
  [
    'accessibilityLabel={copy.rewardPreviewButton}',
    'exam reward preview control must expose localized accessibility labels',
  ],
