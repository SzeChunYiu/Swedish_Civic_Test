...
function validateProgressStoreSchemaParity() {
  ...
  const requiredSnippets = [
    ...
    [
      ...
      'writeProgress must normalize progress before persistence',
    ],
    [
    ...
    [
      ...
      'writeProgress must return the normalized in-memory progress state',
    ],
    [
    ...
    [
      ...
      'progress mutations must return normalized persisted nextProgress',
    ],
    ['set(writeProgress(emptyProgress));', 'resetProgress must persist normalized empty progress'],
  ];
