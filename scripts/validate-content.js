...
const QUESTION_GENERATED_TRUE_FALSE_NATURALNESS_PATTERNS = [
  /^Vatten och avlopp, omsorg, snöröjning, parkskötsel och vuxenutbildning\.$/i,
  /^Water and sewage, care services, snow removal, park maintenance, and adult education\.$/i,
  /^Skicka ambassadörer till andra länder\.$/i,
  /^Sending ambassadors to other countries\.$/i,
...
function swedishResponsibilityObject(value) {
...
function englishResponsibilityObject(value) {
