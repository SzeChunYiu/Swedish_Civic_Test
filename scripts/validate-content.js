...
const EXPECTED_PRACTICE_ROUTE_COPY_LABELS = {
  sv: [
    ...
    'Övningsprov',
    'Hela frågebanken',
    'Öva med hela frågebanken',
    'Starta snabbmix med ${count} frågor',
    '${count} frågor från dina synliga övningsfrågor.',
    'Starta snabbmix',
    'Snabbmix',
    'Aktivt läge: ${scope}',
    'Nästa fråga',
  ...
  en: [
    ...
    'Mock exam',
    'Full question bank',
    'Practise with the full question bank',
    'Start a quick mix with ${count} questions',
    '${count} questions from your visible practice bank.',
    'Start quick mix',
    'Quick mix',
    'Active mode: ${scope}',
    'Next question',
...
const EXPECTED_PRACTICE_ROUTE_COPY_SNIPPETS = [
  ...
  [
    ...
    'practice route must render tokenized chapter progress cards',
  ],
  [
    "import { chapters } from '../../data/chapters';",
    'practice route must import chapter metadata',
  ],
  ...
  [
    ...
    'practice route must scope completed progress to the active practice bank',
  ],
  [
    'getMixedPracticeRoundQuestions(filteredQuestions, completedQuestionIds, 10)',
    'practice route must build a 10-question quick round from visible questions',
  ],
  [
    'getPracticeQuestionsForChapter(filteredQuestions, practiceScope.chapterId)',
    'practice route must scope chapter starts to that chapter only',
  ],
  [
    'getPracticeChapterStats(filteredQuestions, chapter.id, questionProgress)',
    'practice route must derive per-chapter stats from progress',
  ],
  [
    'accessibilityLabel={copy.quickRoundAccessibilityLabel(quickRoundQuestions.length)}',
    'quick-round launcher must expose localized accessibility copy',
  ],
  [
    '{copy.quickRoundDescription(quickRoundQuestions.length)}',
    'quick-round card must render localized count copy',
  ],
  [
    'accessibilityLabel={copy.chapterStartAccessibilityLabel(',
    'chapter practice cards must expose localized start labels',
  ],
  [
    'onPress={() => handleStartChapter(chapter.id)}',
    'chapter practice cards must start scoped chapter rounds',
  ],
  ['href="/exam"', 'practice hub must include a mock exam CTA link'],
  [
