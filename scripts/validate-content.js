...
const EXPECTED_EXAM_ROUTE_COPY_SNIPPETS = [
  ...
  ['{copy.rewardPreviewTitle}', 'exam rewarded preview title must render localized copy'],
  ['{copy.rewardPreviewBody}', 'exam rewarded preview body must render localized copy'],
  ['{copy.rewardPreviewButton}', 'exam rewarded preview action must render localized copy'],
