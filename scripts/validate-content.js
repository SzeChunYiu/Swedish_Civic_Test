...
function validateStaticHeadMetadataParity() {
  ...
  if (!result.ok) {
    fail(`static head metadata invalid: ${result.details}`);
  }

  return {
    outcomeClaimPatternsValidated: result.outcomeClaimPatternsValidated,
    parityValidated:
      result.ok &&
      result.titleValidated &&
      result.outcomeClaimPatternsValidated === result.outcomeClaimPatternsTotal,
    titleValidated: result.titleValidated,
  };
}
...
let staticHeadMetadataTitleValidated = false;
...
{
  const staticHeadMetadataValidation = validateStaticHeadMetadataParity();
  staticHeadMetadataTitleValidated = staticHeadMetadataValidation.titleValidated;
  staticHeadMetadataOutcomeClaimPatternsValidated =
    staticHeadMetadataValidation.outcomeClaimPatternsValidated;
  staticHeadMetadataParityValidated = staticHeadMetadataValidation.parityValidated;
}
